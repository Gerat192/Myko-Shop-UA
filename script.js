...
products = [
    new Product("PS 5", 20000, "загрузка.jpeg"),
    new Product("Cyperpunk", 2000, "Cyberpunk 2077.webp"),
    new Product("Nvidia RTX", 25000, "RTX 4090.webp"),
    new Product("Marcus Fenix", 1000, "Marcus Fenix.webp"),
    new Product("1984", 500, "1984.webp"),
    new Product("Resident Evil", 1000, "Resident Evil Village PS5.webp"),
    new Product("Xbox", 25000, "Xbox Series X.jpeg"),
